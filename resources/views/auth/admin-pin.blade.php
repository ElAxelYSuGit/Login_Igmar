...
<form id="adminPinForm" class="space-y-4">
    <div>
        ...
        <input type="password" id="pin" maxlength="6" class="mt-1 block w-full px-4 py-3 text-center text-2xl tracking-widest border border-gray-300 rounded-md focus:ring-gray-800 focus:border-gray-800" placeholder="••••••" required>
    </div>
